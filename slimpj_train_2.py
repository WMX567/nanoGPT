...
slurm_job_id: int = int(os.environ.get('SLURM_JOB_ID', 0))
slurm_array_task_id: int = int(os.environ.get('SLURM_ARRAY_TASK_ID', 0))
anneal_wd = False
...
if dataset != 'slim_pajama':
    data_dir = os.path.join('/scratch1/mengxiwu/nanoGPT/data', dataset)
    def get_batch(split):
