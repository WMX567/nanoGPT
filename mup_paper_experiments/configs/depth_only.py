...
model_configs = [
    ...
    {'n_embd': 320, 'n_head': 5, 'n_kv_head': 5, 'n_layer': 4,  'weight_decay': WEIGHT_DECAY, 'log_wandb': 'true', 'wandb_project': WANDB_PROJECT, 'n_gpus': 2, 'gradient_accumulation_steps': 3, 'batch_size': 55, 'max_iters': 649},
    {'n_embd': 384, 'n_head': 6, 'n_kv_head': 6, 'n_layer': 4,  'weight_decay': WEIGHT_DECAY, 'log_wandb': 'true', 'wandb_project': WANDB_PROJECT, 'n_gpus': 2, 'gradient_accumulation_steps': 3, 'batch_size': 62, 'max_iters': 727},
    ...
    {'n_embd': 320, 'n_head': 5, 'n_kv_head': 5, 'n_layer': 64, 'weight_decay': WEIGHT_DECAY, 'log_wandb': 'true', 'wandb_project': WANDB_PROJECT, 'n_gpus': 4, 'gradient_accumulation_steps': 5, 'batch_size': 70, 'max_iters': 1378},
    {'n_embd': 384, 'n_head': 6, 'n_kv_head': 6, 'n_layer': 64, 'weight_decay': WEIGHT_DECAY, 'log_wandb': 'true', 'wandb_project': WANDB_PROJECT, 'n_gpus': 4, 'gradient_accumulation_steps': 5, 'batch_size': 83, 'max_iters': 1630},
]
